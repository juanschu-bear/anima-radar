...
export default function RadarPage() {
  ...
  async function startScan(event: FormEvent<HTMLFormElement>) {
    ...
    try {
      ...
      setNotice(text("The scan finished, but no matching businesses were found yet. Try a broader category or add a prospect manually.", "El escaneo terminó, pero aún no se encontraron empresas coincidentes. Prueba con una categoría más amplia o añade un prospecto manualmente."));
    } catch (cause) {
