...
export default function AppShell({ children }: { children: React.ReactNode }) {
  ...
  const currentLabel = pathname === "/admin/companies" ? text("Companies", "Empresas")
    : pathname === "/admin/users" ? text("Access", "Acceso")
  ...
  return <div className="app-shell">
    ...
    <aside className="sidebar">
      ...
      <div className="admin-nav-slot" aria-busy={isAdmin === null}>{isAdmin === true && <><p className="nav-label">{text("Platform admin", "Admin de plataforma")}</p><nav className="primary-nav" aria-label={text("Platform admin", "Admin de plataforma")}><Link href={"/admin/companies" as Route} className={pathname === "/admin/companies" ? "active" : ""}><Icon name="overview"/><span>{text("Companies", "Empresas")}</span></Link><Link href={"/admin/users" as Route} className={pathname === "/admin/users" ? "active" : ""}><Icon name="profile"/><span>{text("Access", "Acceso")}</span></Link></nav></>}</div>
